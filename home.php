                    ...
                    <div class="header-user-actions">
                        <div class="dropdown">
                            ...
                            <ul tabindex="-1" class="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                                <li><a href="">Hello ,<?php echo $_SESSION['name']; ?> </a>
                                </li>
                                    ...
                                    <div class="showcase">
                                        ...
                                        <div class="showcase-content">
                                            ...
                                            <div class="countdown-box">
                                                ...
                                                <!--count down  -->
                                                <a href="https://logwork.com/countdown-7vis" class="countdown-timer" data-timezone="Asia/Kolkata" data-date="2022-05-1 24:00">Countdown</a>
